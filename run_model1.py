...
# (missingness counts, feature counts, etc.), even after closing Spyder,
# on top of the JSON/PNG summary files the model script itself always saves.
LOG_PATH = f"{FOLDER}\\model1_run_log_{datetime.now():%Y%m%d_%H%M%S}.txt"
